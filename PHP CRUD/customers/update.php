...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE `customers` SET`customer_name` = '$name',`phone_no` = '$phone_no',
                                    ...
                                    <div class="p-6 shadow-md lg:p-9 bg-gray-50 dark:bg-gray-900 ">
                                        ...
                                        <form action="" method="post" class="p-0 m-0">
                                            <div class="">
                                                ...
                                                <input type="text" class="w-full px-4 py-3 mt-3 bg-gray-200 rounded-lg dark:text-gray-400 dark:bg-gray-800 " name="name" placeholder="Enter your name" autocomplete="off" value=<?php echo $name; ?>>
                                            </div>
                                            <div class="mt-2">
                                                <label for="" class="text-lg font-medium text-gray-700 dark:text-gray-400">Phone No</label>
                                                <input type="number_format" class="w-full px-4 py-3 mt-3 bg-gray-200 rounded-lg dark:text-gray-400 dark:bg-gray-800 " name="phone_no" placeholder="Enter your phone no" autocomplete="off" value=<?php echo $phone; ?>>>
                                            </div>

                                            <div class="mt-2">
                                                <label for="" class="text-lg font-medium text-gray-700 dark:text-gray-400">Email:</label>
                                                <input type="email" class="w-full px-4 py-3 mt-3 bg-gray-200 rounded-lg dark:text-gray-400 dark:bg-gray-800 " name="email" placeholder="Enter your mail" autocomplete="off" value=<?php echo $email; ?>>>
                                            </div>
                                            <div class="mt-2">
                                                <label for="" class="text-lg font-medium text-gray-700 dark:text-gray-400">Address</label>
                                                <input type="text" class="w-full px-4 py-3 mt-3 bg-gray-200 rounded-lg dark:text-gray-400 dark:bg-gray-800 " name="address" placeholder="Enter Address" autocomplete="off" value=<?php echo $address; ?>>>
                                            </div>
                                            <div class="mt-2">
                                                <div>
                                                    <label for="" class="text-lg font-medium text-gray-700 dark:text-gray-400 ">Password:</label>
                                                    <div class="relative flex items-center mt-2">
                                                        <input type="password" class="w-full px-4 py-3 bg-gray-200 rounded-lg dark:text-gray-400 dark:bg-gray-800 " name="password" placeholder="Enter Password" value=<?php echo $password; ?>>>
                                            ...
                                            <button class="motion-safe:animate-bounce w-full px-4 py-3 mt-5 font-semibold text-gray-200 bg-blue-500 rounded-lg dark:bg-blue-500 hover:text-blue-200 " name="update">Update</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
